...
```c file=../../embed/c/raytracer/util.h title="util.h"
```

우선 공통으로 쓰일 부분들을 따로 함수로 빼 두자.

```c file=../../embed/c/raytracer/util.c title="util.c"
```
...
```c file=../../embed/c/raytracer/ray.h title="ray.h"
```

일단 `ray.h`를 공통으로 쓰도록 빼 두고,

```c file=../../embed/c/raytracer/camera.h title="camera.h"
```
...
```c file=../../embed/c/raytracer/perspective_camera.c title="perspective_camera.c"
```
...
```c file=../../embed/c/raytracer/orthogonal_camera.c title="orthogonal_camera.c"
```
